...
/**
 * Returns a __MY_FLASH_STRING pointer to a status code name.
 * 
 * @return const __MY_FLASH_STRING *
 */
const __MY_FLASH_STRING *MFRC522::GetStatusCodeName(MFRC522::StatusCode code	///< One of the StatusCode enums.
										) {
	switch (code) {
...
/**
 * Returns a __MY_FLASH_STRING pointer to the PICC type name.
 * 
 * @return const __MY_FLASH_STRING *
 */
const __MY_FLASH_STRING *MFRC522::PICC_GetTypeName(PICC_Type piccType	///< One of the PICC_Type enums.
													) {
	switch (piccType) {
