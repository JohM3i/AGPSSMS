...
// use 8 MhZ on BLE
//#define SPI_CLOCK_DIV4 8000000
#define MFRC522_SPICLOCK SPI_CLOCK_DIV4			// MFRC522 accept upto 10MHz

#define __MY_FLASH_STRING char
// else it would be char/__FlashStringHelper
...
public:
	...
	static const __MY_FLASH_STRING *GetStatusCodeName(StatusCode code);
	static PICC_Type PICC_GetType(byte sak);
	// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
	//const char *PICC_GetTypeName(byte type);
	static const __MY_FLASH_STRING *PICC_GetTypeName(PICC_Type type);
